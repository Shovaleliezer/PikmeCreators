...
router.post('/wallet-connect/:walletAddress', async (req, res, next ) => {
    ...
    if(createNewAccount){
        ...
        var dt = new Date();   
        const {nickName, image, about, moneyWon, matchHistory, creationDate} = {nickName:namelist[Math.floor(Math.random() * namelist.length)], image:"https://images.unsplash.com/photo-1561211919-1947abbbb35b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8YWJzdHJhY3QlMjBibHVlfGVufDB8fDB8fA%3D%3D&w=1000&q=80",

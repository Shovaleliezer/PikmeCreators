      ...
      {isMobile && <section className="stream-mobile" >
        <section className="left-wrapper">
          ...
          <div className="lower" >
            ...
            <img src={require('../style/imgs/stream/switch-camera.png')} onClick={() => setCameraIdx(cameraIdx === channelParameters.cameras.length - 1 ? 0 : cameraIdx + 1)} />
          </div>
        </section>
        <StreamChat eventName={event.category == "sports" ? `${event._id}` : `${event._id}`}
          mobile={true} end={status === 'ended'} cameraIdx={cameraIdx} cameras={channelParameters.cameras} />
      </section>
      }
      {modal && <>

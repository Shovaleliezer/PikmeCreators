...
import { getTimeUntil } from '../services/utils'
...
export function AgoraStream() {
    ...
    const currentEvent = useSelector((storeState) => storeState.generalModule.streamInfo)
    ...
    const joinRoom = async () => {
        try {
            ...
            let token = await httpService.get(`handle-stream/${currentEvent._id}/audience/uid/${uid}`)

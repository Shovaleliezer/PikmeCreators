...
export function Stream() {
    ...
    const createVideo = async () => {
        try {
            ...
            if (isMobile) delete config.cameraId
            else delete config.facingMode
            ...
            {isMobile && <section className="stream-mobile" >
                <section className="left-wrapper">
                    ...
                    <div className="lower" >
                        ...
                        <img src={require('../style/imgs/stream/switch-camera.png')} onClick={switchCamera2} />
                    </div>
                </section>

...
export function Header(props) {
    ...
    return (
        <>
            {!location.pathname.includes('creator') &&
                !isMobile && <nav className={`header noselect`}>
                    ...
                    <div className="options-bar">
                        <svg onClick={() => { filterClick('valorant') }} width="30" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className='clickable hover-main-svg'>
                            <linearGradient
                                id="linearGradient-1"
                                x1="50%"
                                x2="54.584%"
                        ...
                        <span className="material-symbols-outlined menu-icon clickable hover-main" onClick={() => {dispatch(setMenuSide('right'));dispatch(toggleMenu())}}>menu</span>
                    </div>
                </nav>}
            ...
            {/* creator header */}
            {location.pathname.includes('creator') && <div className="header">
                ...
                <NavLink to='/creator/home'><img className="logo" src={require('../style/imgs/logo.png')} /></NavLink>
                <NavLink className='undecorate' to='/creator/create'><div className="create">Create</div></NavLink>
            </div>
            }
        </>
    )

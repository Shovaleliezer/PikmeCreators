        ...
        <>
            <div className="header">
                <div className="options-bar" style={{ flex: '0' }}>
                    ...
                    <NavLink to='/profile'>
                        {user.creator && user.creator.image ? <img className="header-user-img" src={user.creator.image}/> :
                        <svg width="30" height="30" viewBox="0 0 41 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="clickable hover-main-svg">

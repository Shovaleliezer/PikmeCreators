...
const socket = process.env.NODE_ENV === 'production' ? io.connect('https://pikme-server.onrender.com/') : io.connect('http://localhost:3030/')

const StreamChat = ({ mobile, zIndex, end, cameraIdx, cameras }) => {
    const colors = [
    ...
    if (socket) socket.emit('joinRoom', { nickName, roomName:null })
